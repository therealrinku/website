...
const RESPONSES = {
  ...
  linkedin:
    "<div><b style='color:coral;'>Here is my linkedin profile</b><br/><a style='text-decoration:underline;' href='https://www.linkedin.com/in/rinkunited/' target='_blank'>linkedin.com/in/rinkunited</a><p>-----</p></div>",
  projects:
    "<div><b style='color:coral;'>Here are some of my personal projects</b><br/><a style='text-decoration:underline;' href='https://robosocial.web.app/' target=_blank'>Robosocial(social media app)</a><br/><a style='text-decoration:underline;' href='https://taskyoxx.web.app/' target='_blank'>Taskyoxx(todo app)</a> <br/><a style='text-decoration:underline;' href='https://roboshare.vercel.app/' target='_blank'>Roboshare (file sharing app)</a> <p>-----</p></div>",
  introduction:
...
// drag and drop stuff going on here
